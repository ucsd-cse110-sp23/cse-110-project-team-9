...
public class App {
    public static void main(String[] args) {
        new Thread(() -> {
            Server s = new Server(TsvStore.createOrOpenStore("data.tsv"), ServerConstants.SERVER_HOSTNAME,
                    ServerConstants.SERVER_PORT, new Whisper(ServerConstants.OPENAI_API_KEY),
