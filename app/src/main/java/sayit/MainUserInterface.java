...
public class MainUserInterface {
	...
	//FOR TESTING
    private ArrayList<CountDownLatch> latches = null;
		...
		if (MainUserInterface.recorder == null) {
			...
			Thread t = new Thread(() -> {
				...
				if (whisperCheck.isExceptionThrown()) {
					...
					JOptionPane.showMessageDialog(this.frame, TRANSCRIPTION_ERROR_TEXT + question, ERROR_TEXT,
				...
				try {
					...
					JOptionPane.showMessageDialog(this.frame, TRANSCRIPTION_ERROR_TEXT + ex.getMessage(), ERROR_TEXT,
							JOptionPane.ERROR_MESSAGE);
					return;
				}
				...
				button.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
		                ...
		                if (latches != null)
		                	latches.get(latches.size()-1).countDown();
					}
