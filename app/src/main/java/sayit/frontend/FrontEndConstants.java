...
public final class FrontEndConstants {
    ...
    public static final String RECORD_BUTTON_FILENAME = "./Pictures/RecordButton.jpg";
    public static final String STOP_BUTTON_FILENAME = "./Pictures/StopButton.jpg";
    ...
    public static final String CLEAR_ALL_BUTTON_TITLE = "Clear All";
