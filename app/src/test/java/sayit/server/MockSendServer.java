...
public class MockSendServer {
     ...
     */
    private MockSendServer(IEmailConfigurationHelper configHelper, IPromptHelper pHelper, IAccountHelper accountHelper,
        ...
        if (configHelper != null) {
            ...
            this._server.createContext("/send_email", new MockSendHandler(configHelper, pHelper));
        }
